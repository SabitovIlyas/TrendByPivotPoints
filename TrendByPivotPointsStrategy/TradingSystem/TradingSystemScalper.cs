...
namespace TrendByPivotPointsStrategy
{
    public class TradingSystemScalper : TradingStrategy
    {
        ...
        private int limitOpenedPositions = 3;
        
        private int firstPositionLots = 8;
        private int secondPositionLots = 1;
        private int thirdPositionLots = 1;
        private int[] openPositionLots;

        private double firstTakeLevelAtr = 0.5;
        private double secondTakeLevelAtr = 1.5;
        ...
        public void CheckPositionOpenLongCase(int positionNumber)
        {
            ...
            if (!IsPositionOpen(notes))
            {
                ...
                SetLimitOrdersForOpenPosition(positionNumber, entryPrice, notes);
            }
            else
            {
        ...
        private void SetLimitOrdersForOpenPosition(int positionNumber, double entryPrice, string notes)
        {
            if (positionSide == PositionSide.Long)
